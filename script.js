...
function getInfoBasedOnScore(){
    if(totalScore() < 7){
        var score_info = "Você precisa estudar mais um pouco as charadas!";
    } else if(totalScore() > 7){
        var score_info = "Parabéns! Você realmente sabe resolver as charadas!"
    }
...
function growProgressBar(percentage_width){
    var bar = document.getElementById("continuação");
